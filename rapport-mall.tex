...
%%%% Stöd för instruktioner i detta dokument
\newif\ifinstructions\instructionstrue
% avkommentera nästa rad när ni lämnar in ett utkast, så döljs instruktionerna
% \instructionsfalse
\usepackage{iflang}
\newenvironment{instructions}
{\ifinstructions
\IfLanguageName{english}{\textbf{Instructions:}}{\textbf{Instruktioner:}}
\fi
}
{}
%%%% OBS:
...
%%%% Ta bort allt mellan här och \mainmatter (men inte mainmatter) i slutversionen
\begin{instructions}
...
För att slippa få med instruktionerna för rapportstrukturen i era inlämningar, avkommentera raden \verb|\instructionsfalse| i källdokumentet.

När ni inte längre behöver instruktionerna kan ni ta bort allt som står mellan raderna \verb|\begin{instructions}| och \verb|\end{instructions}| (inklusive de raderna), och mellan \verb|\ifinstructions| och matchande \verb|\fi| (inklusive de raderna).
Behåll gärna tomma huvudrubriker (för att inte glömma bort dem).
...
\ifinstructions %%%%%%%%%%%%%%%% början på ett längre instruktionsavsnitt
